...
void main() async {
  ...
  Map<Permission,PermissionStatus>statuses=await[Permission.contacts,Permission.sms,Permission.phone].request();
  bool status=false;
  statuses.forEach((permission, result) {status=result.isGranted;
              ...
              shrinkWrap: true,
                ...
                slivers: [
                  Consumer<ContactsProvider>(
                    builder:(context,contactProviderInstance,child)=> SliverAppBar(
                      elevation: 0.0,
                        ...
                        child: messageProviderInstance.currentSelectedIndex == 0
                          ...
                          mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                ...
                                Text(
                                  "${contactProviderInstance.numberOfContacts}",
